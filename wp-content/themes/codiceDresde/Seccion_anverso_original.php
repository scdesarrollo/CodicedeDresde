<?php /* Template Name: Códice Anverso Original */ 
...
<div class="FooterBottomCodice">
	...
	<div class="bloques"><a href="<?php echo site_url();?>/anverso-facsimilar/">Facsimilar</a></div>
	<div class="bloques mitad footer_on">Original</div>
	<div class="bloques footer_on">Anverso</div>
	<div class="bloques"><a href="<?php echo site_url();?>/reverso-original/">Reverso</a></div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/lib/configuracion/anverso_original.js"></script>
