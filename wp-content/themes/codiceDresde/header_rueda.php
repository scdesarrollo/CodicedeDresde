...
<html <?php language_attributes(); ?> class="no-js">
	...
	<style type="text/css">
		body{ background: #30302D; overflow-x: hidden;}
	  ...
	  <div class="header nav-down">
       ...
       <div class="menuGeneral">
			<div class="BloqueA">
				...
				<div class="menu3 men3 menu_over_3_on""></div>	
			...
			<div class="BloqueB">
				...
				<div class="menu3 menuTitulo men_3 titulo_menu_on"><a href="<?php echo site_url(); ?>/sistemas-cronograficos/">Sistemas Cronográficos</a></div>	
