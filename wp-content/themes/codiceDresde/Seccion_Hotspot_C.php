<?php /*  WP Post Template: Hostspot C */ 
				...
				<!-- Mostrar los datos de Galerias -->
					<?php $repeatable_fields = get_post_meta($post->ID, 'repeatable_fields', true);  if ( $repeatable_fields ) : ?>
						...
						<div class="contenedor_flechas">
   						...
   						<div id="count_hp" class="imagen_hotspot_C">
   						    ...
   						    <span id="imagen_hotspot_C" class="img-slider-<?php echo $var_img; ?> hostspotsContainer">
   							<?php if ($field['img_au'] != '') echo  $field['img_au'];  ?>
   							</span>
   						    
   						    <div class="imagen_hotspot img-bullet-<?php echo $var_img; ?>" style="z-index: 999;">
   						    	<img class="zoom_01" src="<?php echo get_template_directory_uri(); ?>/images/zoom/augurios_encuadres/<?php if($field['imagen_1'] != '') echo   $field['imagen_1']; ?>"/>  
   						    </div>
					...
					<!-- BULLETS ***********************  -->
					<div id="bullets" class="BloqueBullets">

					<div class="contenedor_flechas_mobile">
							<div class="next_C"></div>
   		 					<div class="prev_C"></div>
					</div><!-- Contenedor_flechas -->
						...
						<center>
							...
							<?php $var_contenido = 0; ?>
   						    <?php foreach ( $repeatable_fields as $field ) { ?>
   						   		 <?php $var_contenido++?>
   						    <div class="contenido contenido-bullet-<?php echo $var_contenido; ?>">
							...
							<div class="Bloque_datos_hotspots">
								<div class="lamina"><?php 
								 ...
								 if($field['tematica'] != '') { ?> <b>Temática:</b> <?php echo  $field['tematica'];  } ?></div>
