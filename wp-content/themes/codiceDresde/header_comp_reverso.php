...
<div class="header header_codice nav-down">
      ...
      <div class="btn_materialidad btn_materialidad_hover_on">
       	
       		 <div class="BarraNavegacion">
       		 <div class="triangulo"></div>

       		 	<div class="BloqueA Navegacion_off">
       		 		<a href="<?php echo site_url(); ?>/reverso-facsimilar/">Navegación</a>
       		 	</div><!--BloqueA -->
	
       		 	<div class="BloqueB Comparativa_on">
       		 		Comparativa
       		 	</div><!-- BloqueB -->
       ...
       <div class="btn_hipermedia">
       		<div class="BarraNavegacionB">
       		 <div class="triangulo"></div>

       		 	<div class="BloqueA relase_storage">
