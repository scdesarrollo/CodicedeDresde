  ...
  $wp_query->query('showposts=10&post_type=notas&post_status=publish'.'&paged='.$paged); 
...
?>
			...
			<div class="subcontenedor subcontenedorUpdateNotas show-editar-<?php echo the_ID(); ?>">
				...
				<div class="InformacionDatos">
					<form id="update_post_publica" name="update_post_publica" class="update_post_publica" method="post" action="<?php echo get_template_directory_uri(); ?>/formulario_actualizar_publica.php"> 
					
					<div class="BloqueA">Título</div>
					<div class="BloqueB"><input required title="Necesitas agregar el titulo" type="text" name="titulo_nota" id="titulo_nota" size="45" id="input-title" value="<?php the_title(); ?>" /></div>
					...
					<div class="BloqueG">
						 ...
						 <input type="hidden" name="action" value="update_post_publica">
