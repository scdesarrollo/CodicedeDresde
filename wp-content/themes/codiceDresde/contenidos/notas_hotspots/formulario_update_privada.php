...
// si esta loggeado
  ...
  global $post;
  $valor_nota_nuevo2 = "nota-".$post->ID; 
...
if ( is_user_logged_in() ) {
  ...
  $wp_query->query('showposts=-1&post_type=notas&post_status=private&tag='.$thePostID.'&author='.$numero.'&paged='.$paged); 
...
?>
			...
			<div class="subcontenedor subcontenedorUpdateNotas show-editar-<?php echo the_ID(); ?>">
				...
				<div class="InformacionDatos">
					<form id="update_post" name="update_post" class="update_post_privada_hotspots" method="post" action="<?php echo get_template_directory_uri(); ?>/formulario_actualizar_privada.php"> 
					...
					<div class="BloqueEUpdate span-Form-update-<?php echo the_ID(); ?> flexcroll_ETI tags">
						...
						?>
						 ">
						  ...
						  <input type="hidden" name="id_valor_hp"  id="id_valor_hp" value="<?php echo $valor_nota_nuevo2;?>">
