...
?>
			...
			<div class="subcontenedor subcontenedorUpdateNotas show-editar-<?php echo the_ID(); ?>">
				...
				<div class="InformacionDatos">
					<form id="update_post_publica" name="update_post_publica" class="update_post_publica_hotspots" method="post" action="<?php echo get_template_directory_uri(); ?>/formulario_actualizar_publica.php"> 
					...
					<div class="BloqueEUpdate span-Form-update-<?php echo the_ID(); ?> flexcroll_ETI tags">
						...
						?>
						 ">
						  ...
						  <input type="hidden" name="id_valor_hp"  id="id_valor_hp" value="<?php echo $valor_nota_nuevo;?>">
