...
<html <?php language_attributes(); ?> class="no-js">
	...
	<body  class="flexcroll">
 	...
 	<!-- HEADER NOTAS ============================== -->
	<div class="ContenedorDetalleNotas">
		<?php echo get_template_part("contenidos/notas/detalle_nota_privada"); ?>
		<?php echo get_template_part("contenidos/notas/detalle_nota_publica"); ?>
	</div>



	<?php echo get_template_part("contenidos/notas/formulario_agregar_nota"); ?>

	<!-- HEADER NOTAS ============================== -->
	<div class="ContenedorUpdateNotas">
	<?php echo get_template_part("contenidos/notas/formulario_update_privada"); ?>
	<?php echo get_template_part("contenidos/notas/formulario_update_publica"); ?>
	</div>
	...
	<div class="header nav-down nav-down">
       ...
       <div class="menuGeneral">
			<div class="BloqueA">
				...
				<div class="menu4 men4 menu_over_4_on"></div>	
			...
			<div class="BloqueB">
				...
				<div class="menu4 menuTitulo men_4 titulo_menu_on"><a href="<?php echo site_url(); ?>/notas/">Notas</a></div>	
