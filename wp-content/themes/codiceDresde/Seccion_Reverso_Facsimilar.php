<?php /* Template Name: Códice Reverso Facsimilar */ 

echo get_template_part("header_reverso");
 ?>
...
<div class="FooterBottomCodice">
	...
	<div class="bloques mitad "><a href="<?php echo site_url();?>/reverso-original/">Original</a></div>
	<div class="bloques "><a href="<?php echo site_url();?>/anverso-facsimilar/">Anverso</a></div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/lib/configuracion/reverso_facsimilar.js"></script>
