<?php /*  WP Post Template: Hostspot B */ 
...
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/notas_hotspots/eventos_hp_B.js"></script>
