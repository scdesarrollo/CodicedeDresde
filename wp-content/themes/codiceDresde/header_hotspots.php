...
<html <?php language_attributes(); ?> class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo get_template_directory_uri(); ?>/css/bxSlider/jquery.bxslider.css">
	...
	<?php echo get_template_part("contenidos/notas_hotspots/formulario_agregar_nota_hotspots"); ?>

	<!-- HEADER NOTAS ============================== -->
	<div class="ContenedorUpdateNotas">
		<?php echo get_template_part("contenidos/notas_hotspots/formulario_update_publica"); ?>
		<?php echo get_template_part("contenidos/notas_hotspots/formulario_update_privada"); ?>
	</div>


<div class="header header_codice">
       ...
       <div class="btn_materialidad">
       		 ...
       		 <div class="triangulo"></div>
       		 	...
       		 	<div class="BloqueA">
       		 	<a href="<?php echo site_url(); ?>/anverso-facsimilar/">Navegación  
       		...
       		<div class="BarraNavegacionB">
       		 ...
       		 <?php
      			...
      			if ($lister=="deidades_encuadres") { ?>
      				...
      				<div class="BloqueA select_tema">
       		 			<a href="<?php echo site_url(); ?>/hypermedia-dioses/">Dioses</a>
       		 		</div><!--BloqueA -->
      			...
      			<?php } else { ?>
					...
					<div class="BloqueA">
       		 		...
       		 		<div class="BloqueB relase_storage select_tema">
       		 			<a href="<?php echo site_url(); ?>/hypermedia-augurios/">Augurios</a>
       		 		</div><!-- BloqueB -->
