<?php /* Template Name: Códice hipermedia: Deidades */ 

echo get_template_part("header_hipermedia_dioses");
 ?>
...
<script type="text/javascript"> var RutahypermediaDeidades = '<?php echo site_url(); ?>/Hotspots/deidades-';  </script> 

<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/lib/openseadragon/openseadragon.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/lib/configuracion/hipermedia_deidades.js"></script>
